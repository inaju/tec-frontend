...
const InfoCardImages = ({ image_one, image_two }: IInfoCard) => {
  ...
  h-[14.625rem] sm:h-[14.625rem] sm:min-w-[17rem]   sm:max-w-[29rem] sm:w-full sm:h-full
  ...
  return (
    ...
    >
      <div
        className={`${imageDimensions} absolute z-1 left-[2.8125rem]  lg:left-[8.8125rem] `}
      >
        <img
      ...
      <div
        className={`${imageDimensions} absolute top-[6.25rem] xl:top-[9.25rem] mb-10
        s`}
      >
